...
![Topology](images/3f1-1-Topology.jpg){ width="55%" style="display: block; margin: 0 auto;" }
...
See [Network Services - Subnets](3h1-network-subnet.md#networkservices)

* **Create a Load Balancer in front of the VM**  
See [Network Services - VM Load Balancers](3h5-network-lb.md#networkservices)
