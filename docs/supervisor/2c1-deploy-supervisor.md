...
* **Supervisor**
    ...
    * [Access via CLI](2c2-access-supervisor.md)
</div>
...
![Add Supervisor Wizard](images/2c1-1-AddSupervisor.jpg){ width="65%" style="display: block; margin: 0 auto;" }
...
2. **Supervisor Location**  
    * Select the **Cluster Deployment**, and click **Next**.  
    ![Supervisor Location Settings](images/2c1-1b-Supervisor.jpg){ width="95%" style="display: block; margin: 0 auto;" }  

3. **Storage**  
    * Select the different **Storage Policies**, and click **Next**.  
    ![Storage Policy Selection](images/2c1-1c-Storage.jpg){ width="95%" style="display: block; margin: 0 auto;" }  

4. **Management Network**  
    * Configure the **Supervisor Management IP Settings**, and click **Next**.  
    ![Management Network IP Settings](images/2c1-1d-Management.jpg){ width="95%" style="display: block; margin: 0 auto;" }  

5. **Workload Network**  
    * Configure the **Workload Network** (fields are pre-populated, except for DNS and NTP Servers), and click **Next**.  
    ![Workload Network Configuration](images/2c1-1e-Workload.jpg){ width="95%" style="display: block; margin: 0 auto;" }  
...
6. **Advanced Settings**  
    * Select the **Supervisor Control Plane Size**, and click **Next**.  
    ![Advanced Settings and Sizing](images/2c1-1f-Advanced.jpg){ width="95%" style="display: block; margin: 0 auto;" }  

7. **Ready to Complete**  
    * Review your configuration and click **Finish**.  
    ![Review and Complete](images/2c1-1g-Ready.jpg){ width="95%" style="display: block; margin: 0 auto;" }  
...
Navigate to **vCenter** > **Supervisor Management** > **Supervisors**, select **[your supervisor]**, and click on **Kubernetes Service - Manage**.
    ![vCenter Server and Network Configuration](images/2c1-4a-Supervisor.jpg){ width="95%" style="display: block; margin: 0 auto;" }  
...
![Supervisor Validation Status](images/2c1-5a-Validation.jpg){ width="95%" style="display: block; margin: 0 auto;" }
...
![Supervisor Validation Status](images/2c1-5b-Validation.jpg){ width="85%" style="display: block; margin: 0 auto;" }
