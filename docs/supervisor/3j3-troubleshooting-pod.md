...
As described in the [Packet Walk - E/W Pod to Pod](3i3-packetwalk-pod_pod.md) section, Pod accessing a Pod traverse the following path:
...
* **Validate the ESX host accept large packets (MTU)**   
