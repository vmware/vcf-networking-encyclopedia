...
* **Deploy App (VMs)**
    * [via vCenter UI](3f1-deployment-vms.md)
    * [**via CLI**](#deployment_vms)
* Deploy App (K8s)
    * [via CLI](3g1-deployment-pods.md)
</div>
...
![Topology](images/3f2-1-Topology.jpg){ width="55%" style="display: block; margin: 0 auto;" }
...
See [Namespace Access via CLI](3d2-access-namespace.md#namespacek8sclient)
...
```
    ...
    ??? abstract "Output example"
        ...
        web-lb-vip   LoadBalancer   172.29.218.218   <b>10.150.0.7</b>    80/TCP    24s
        </code></pre>
...
```text
curl http://10.150.0.7
```

??? abstract "Output example"
    <pre><code>PS C:\Users\Administrator\Documents> <b>curl http://10.150.0.7</b>
