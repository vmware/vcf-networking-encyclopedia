...
![Topology](images/3g1-1-Topology.jpg){ width="55%" style="display: block; margin: 0 auto;" }
...
See [Connect to the K8s Cluster](3e3-access-k8s.md#access_k8s)
...
```
    ...
    ??? abstract "Output example"
        ...
        apache-vip-service   LoadBalancer   10.101.142.113  <b>10.150.0.9</b>    80:30869/TCP   53s
        </code></pre>
...
??? abstract "Output example"
    <pre><code>PS C:\Users\Administrator\Documents> <b>curl http://10.150.0.9</b>
    &lt;h1&gt;It works - Pod: <b>apache-deployment-58bf9564f6-fmll8</b>&lt;/h1&gt;
    &nbsp;
    PS C:\Users\Administrator\Documents> <b>curl http://10.150.0.9</b>
    &lt;h1&gt;It works - Pod: <b>apache-deployment-58bf9564f6-57zdv</b>&lt;/h1&gt;
    </code></pre>
